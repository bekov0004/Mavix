        ...
        <div class="overflow-x-auto">
          <table class="w-full border-collapse text-left">
            ...
            <tr class="bg-slate-50/50 border-b border-slate-200 dark:bg-slate-800/50 dark:border-slate-800">
              ...
              <th class="p-6 w-20 text-center text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Actions</th>
            </tr>
            </thead>
            ...
            <tr v-for="key in allKeys" :key="key"
              ...
              <td v-for="lang in languages" :key="lang" class="p-4">
                <textarea
                    ...
                    :class="!translations[lang][key] && !pendingDelete.has(key) ? 'bg-red-50/50 placeholder-red-300 dark:bg-red-900/10' : ''"
                    placeholder="Empty..."
                ></textarea>
              </td>
